...
1. Create a new working branch ... Be sure to remember to do all of your work on non-master branches.
1. Ensure that all your local changes are committed and pushed to your origin repo in your working branch.
1. Visit the origin repo on github.com
1. Create a new PR from your working branch on your fork to your master branch
